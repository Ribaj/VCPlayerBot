...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Channel', url='https://t.me/LatestNetflixMovie2022'),
            InlineKeyboardButton('🧩 Group', url='https://t.me/+reW3FyLznTI3MWFl')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        ...
        [
            InlineKeyboardButton("👨‍💻 Creator", url='https://t.me/aditya1190'),
            InlineKeyboardButton('🗑 Close', callback_data='close'),
        ]
    ]
    await message.reply("<b>Want source code of this bot ask master<a href=https://t.me/aditya.</a>\nsupport channel @LatestNetflixMovie2022.</b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
    await delete_messages([message])
