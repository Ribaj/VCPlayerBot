...
async def reply(client, message): 
    try:
        ...
        await message.reply(f"{Config.REPLY_MESSAGE}\n\n<b>You can't use this bot in your group, for that you have to make your own bot ask master for the source code [CREATOR](https://github.com/subinps/VCPlayerBot) below.</b>", disable_web_page_preview=True)
